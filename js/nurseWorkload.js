...
// get total number of data for multi-line table
// x means x main type
function getTotalNumBef(data, x){
    var totalNum = 0;
    for(var i = 0; i<x; i++){
...
function insertHSGZLTable(){
	...
	for(var x=0;x<HSGZLtableData.length;x++){
		for(var i=0;i<HSGZLtableData[x].groupRows.length;i++){
            ...
            var tdIndexTemp = (nurseWorkloadpage-1) * HSGZLnumPer + getTotalNumBef(HSGZLtableData, x) + i + 1;
